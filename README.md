...
Hi, I'm **Chirag Pahlajani**, a passionate **Full Stack Developer** with **2+ years** of experience. <br/>I specialize in Angular.
...
<span style="display:inline-block;text-align:center;width:60px;margin-right:10px;background-color:red;border-radius:8px;padding:4px;">
  <img src="https://cdn.simpleicons.org/angular/white" width="32" height="32" style="display:block;margin:0 auto;" />
  <span style="font-size:11px;display:block;margin-top:4px;color:white;">Angular</span>
</span>
<span style="display:inline-block;text-align:center;width:60px;margin-right:10px;background-color:#000000;border-radius:8px;padding:4px;">
  <img src="https://cdn.simpleicons.org/nextdotjs/white" width="32" height="32" style="display:block;margin:0 auto;" />
  <span style="font-size:11px;display:block;margin-top:4px;color:white;">Next.js</span>
</span>
...
<span style="display:inline-block;text-align:center;width:60px;margin-right:10px;background-color:#000000;border-radius:8px;padding:4px;">
  <img src="https://cdn.simpleicons.org/express/white" width="32" height="32" style="display:block;margin:0 auto;" />
...
<span style="display:inline-block;text-align:center;width:60px;margin-right:10px;background-color:#000000;border-radius:8px;padding:4px;">
  <img src="https://cdn.simpleicons.org/github/white" width="32" height="32" style="display:block;margin:0 auto;" />
...
MindMatrix is a modern e-learning platform designed to make online education more engaging, personalized, and accessible. It allows learners to explore various courses, track their progress, and interact with dynamic content — all within a user-friendly interface.

Built with scalability and performance in mind, MindMatrix provides features like user authentication, course management, progress tracking, and interactive quizzes to enhance the overall learning experience.
